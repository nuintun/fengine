...
Transform.prototype.matchLayout = function (){
  ...
  var command = null;
  var context = this;
  var match = context.regexp.layout.exec(context.source);
  ...
  if (match) {
    while (match) {
      ...
      match = context.regexp.layout.exec(context.source);
    }
  } else {
 ...
 * @returns {boolean}
 */
Transform.prototype.isCyclic = function (src){
  var context = this;
