...
/**
 * Normalize `args`. For example
 * This normalizes equal sign and splits "--abc=def" into "--abc def".
 *
 * @param {Array} args
 * @return {Array}
 * @api private
  ...
  for (var i = 0; i < len; ++i) {
    ...
    if (option) {
      ...
      if (option.required) {
        ...
        if (undefined === arg) return this.optionMissingArgument(option);
 ...
 *
 * @param {Command} cmd to output help for
 * @param {Array} options of options to search for -h or --help
 * @api private
 */
