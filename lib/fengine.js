...
Fengine.prototype = {
  dir: function (files, dir){
    var html = '<!DOCTYPE html>'
      ...
      + '    <title>' + dir + '</title>'
      + '    <style>'
      + '      html, body, hr, a{ margin: 0; padding: 0; font-family: '
      + '        "Lucida Console", Consolas, "Liberation Mono", Menlo, Courier, monospace; }'
      + '      h1 { margin: 6px 0; }'
  ...
  error: function (response, statusCode, next){
    var html = '<!DOCTYPE html>'
      ...
      + '    <style>'
      + '      html, body, p{ margin: 0; padding: 0; font-family: '
      + '        "Lucida Console", Consolas, "Liberation Mono", Menlo, Courier, monospace; }'
      + '      p { margin: 8px; }'
      + '    </style>'
      + '  </head>'
